...
{
    public partial class Log_Normal_Distribution_Polar : IRandom_Number
    {
        ...
        retry_point:
            ...
            result_double= Math.Exp(result_double);
            return result_double;
        }
        ...
        retry_point:
            ...
            result_double = Math.Exp(result_double * Math.Abs(std) + average);
            return result_double;
        }
